...
public class Constants {
	...
	public static final String VERSION = "1.5.3c";
	public static final String DEPENDENCIES = "required-after:atlaslib@[1.1.9,);after:baubles;after:galacticraft;before:deathchest;before:corpse;before:jei";
