...
public class ZombiePlayerEntity extends ZombieEntity implements PlayerZombie<ZombiePlayerEntity> {
	...
	public ZombiePlayerEntity(EntityType<? extends ZombiePlayerEntity> type, World level) {
		super(type, level);
	}

	public ZombiePlayerEntity(World level) {
	...
	protected void doUnderWaterConversion() {
		if (ZombiePlayersConfig.drownedPlayers.get()) {
			ZombieEntity drowned = convertTo(HordesEntities.DROWNED_PLAYER.get(), true);
			if (drowned != null) {
