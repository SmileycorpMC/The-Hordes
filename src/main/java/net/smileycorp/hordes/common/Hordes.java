...
public class Hordes {
	...
	public Hordes() {
		...
		//generate data files
		if (DefaultDataGenerator.tryGenerateDataFiles()) HordesLogger.logInfo("Generated default config files.");
		else HordesLogger.logInfo("Config files exist, skipping generation");
	}
