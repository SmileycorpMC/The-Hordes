...
public class HordeSpawnTypes {
    ...
    public static final HordeSpawnType PREFER_WATER = register("prefer_water", (level, pos) -> level.getBlockState(pos.below()).getFluidState().m_205070_(FluidTags.WATER));
    public static final HordeSpawnType PREFER_LAVA = register("prefer_lava", (level, pos) -> level.getBlockState(pos.below()).getFluidState().m_205070_(FluidTags.LAVA));
    public static final HordeSpawnType IGNORE_WATER = register("ignore_water", (level, pos) -> {
        ...
        return state.isEmpty() || state.m_205070_(FluidTags.WATER);
    });
