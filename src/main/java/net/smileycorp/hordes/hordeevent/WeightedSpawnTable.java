...
public class WeightedSpawnTable extends WeightedOutputs<HordeSpawnEntry> {
    ...
    public List<HordeSpawnEntry> getResults(Random rand, int tries) {
    ...
    public HordeSpawnEntry getEntry(Random rand, List<Entry<HordeSpawnEntry, Integer>> mappedEntries, int max) {
