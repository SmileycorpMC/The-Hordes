...
public class ZombiePlayerCapeLayer<T extends ZombieEntity & IZombiePlayer> extends LayerRenderer<T, ZombiePlayerModel<T>> {
	...
	public void render(MatrixStack matrixStack, IRenderTypeBuffer buffer, int size, T entity, float p_225628_5_, float p_225628_6_, float p_225628_7_, float p_225628_8_, float p_225628_9_, float p_225628_10_) {
		...
		if (playerInfo != null && !entity.isInvisible() && entity.displayCape() && playerInfo.getCapeLocation() != null) {
			...
			if (itemstack.getItem() != Items.ELYTRA) {
				...
				double d0 = MathHelper.lerp((double)p_225628_7_, entity.getXCloakO(), entity.getXCloak()) - MathHelper.lerp((double)p_225628_7_, entity.xo, entity.getX());
				double d1 = MathHelper.lerp((double)p_225628_7_, entity.getYCloakO(), entity.getYCloak()) - MathHelper.lerp((double)p_225628_7_, entity.yo, entity.getY());
				double d2 = MathHelper.lerp((double)p_225628_7_, entity.getZCloakO(), entity.getZCloak()) - MathHelper.lerp((double)p_225628_7_, entity.zo, entity.getZ());
