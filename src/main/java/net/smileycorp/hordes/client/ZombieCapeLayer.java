...
public class ZombieCapeLayer<T extends PathfinderMob & IZombiePlayer> extends RenderLayer<T, ZombiePlayerModel<T>> {

	public ZombieCapeLayer(ZombiePlayerRenderer<T> parent, ZombiePlayerModel<T> model) {
		super(parent);
	}
