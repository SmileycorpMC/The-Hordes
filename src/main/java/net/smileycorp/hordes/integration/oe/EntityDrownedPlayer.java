package net.smileycorp.hordes.integration.oe;
...
public class EntityDrownedPlayer extends EntityDrowned implements PlayerZombie<EntityDrownedPlayer> {

	public static final PlayerZombie.Type<EntityDrownedPlayer> TYPE = new PlayerZombie.Type<>("drowned", EntityDrownedPlayer.class);

	protected static final DataParameter<Optional<UUID>> PLAYER = EntityDataManager.createKey(EntityDrownedPlayer.class, DataSerializers.OPTIONAL_UNIQUE_ID);
	protected static final DataParameter<Boolean> SHOW_CAPE = EntityDataManager.createKey(EntityDrownedPlayer.class, DataSerializers.BOOLEAN);
	...
	public EntityDrownedPlayer(World world) {
		super(world);
	}
	...
	public ITextComponent getDisplayName() {
		despawnEntity();
		TextComponentTranslation textcomponentstring = new TextComponentTranslation(ScorePlayerTeam.formatPlayerName(getTeam(), "entity.hordes.drowned_player.chat"), ScorePlayerTeam.formatPlayerName(getTeam(), getName()));
	...
	@Override
	public Type<EntityDrownedPlayer> getType() {
		return TYPE;
	}

	//gradle is being stinky, for some reason it refuses to deobf these
	@Override
